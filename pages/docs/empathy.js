...
<div id="data_structures_empathy" className="card " >
                            <div className="card-header card-header-secondary" style={{background:"linear-gradient(60deg, #391141, #8e24aa)"}}>
                                <h3 id="h3_empathy_1" className="my-0 text-white">Empathy</h3>
                            </div>
                                ...
                                <div className="d-flex justify-content-center">
                                    <table className="table table-responsive table-striped w-auto rounded-top rounded-bottom border">
                                        ...
                                        <tr>
                                            ...
                                            <td id="td_empathy_4">Unique ID of user's empathy towards the target user</td>
                                        </tr>
                                        <tr>
                                        ...
                                        <tr>
                                            ...
                                            <td id="td_empathy_14"><a href="#data_structures_affect">Affect</a></td>
                                            <td id="td_empathy_15" className="text-nowrap">Default <a href="#data_structures_affect">Affect</a></td>
                                            <td id="td_empathy_16">User's adapted affective state to the target user</td>
                                        </tr>
                                        </tbody>
                                    </table>
                                </div>
